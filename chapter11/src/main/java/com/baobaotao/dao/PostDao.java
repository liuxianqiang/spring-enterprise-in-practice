...
public class PostDao {
	...
	public void getNativeConn() throws SQLException {
		Connection dbcpConn = DataSourceUtils.getConnection(jdbcTemplate.getDataSource());
		System.out.println(dbcpConn.getClass());
		Connection jdbcConn = jdbcTemplate.getNativeJdbcExtractor().getNativeConnection(dbcpConn);
		System.out.println(jdbcConn.getClass());
	};
