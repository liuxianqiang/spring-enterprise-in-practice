...
insert into t_topic (topic_id, forum_id, topic_title, user_id, topic_time, topic_views, topic_replies) values (3, 3, '主题3', 1, '1-1-1 0:0:1', 130, 70);

insert into t_topic (topic_id, forum_id, topic_title, user_id, topic_time, topic_views, topic_replies) values (4, 0, '主题4', 2, '1-1-1 0:0:2', 166, 22);
